package com.qh.ruyi.log.aspect;
...
import com.qh.ruyi.log.event.SysLogEvent;
import com.qh.ruyi.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.qh.ruyi.log.annotation.SysLog)")
