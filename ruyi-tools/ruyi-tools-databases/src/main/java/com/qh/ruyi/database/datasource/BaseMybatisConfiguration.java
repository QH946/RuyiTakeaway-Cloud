package com.qh.ruyi.database.datasource;
...
import com.qh.ruyi.base.id.IdGenerate;
import com.qh.ruyi.base.id.SnowflakeIdGenerate;
import com.qh.ruyi.database.mybatis.typehandler.FullLikeTypeHandler;
import com.qh.ruyi.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.qh.ruyi.database.mybatis.typehandler.RightLikeTypeHandler;
import com.qh.ruyi.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "ruyi.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
