...
public class BaseContextConstants {
    ...
    public static final String JWT_KEY_SEX = "sex";
    public static final String JWT_KEY_IDNUMBER = "idnumber";
    public static final String JWT_KEY_STATUS = "status";
    public static final String JWT_KEY_AVATAR = "avatar";
}
